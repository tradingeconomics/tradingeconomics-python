...
class TestGetHistoricalEurostatDates(unittest.TestCase):
    ...
    def test_historical_eurostat_with_init_date(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/eurostat/historical/24804?d1=2015-01-01&c=TESTKEY"
    ...
    def test_historical_eurostat_with_date_range(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/eurostat/historical/24804?d1=2015-01-01&d2=2020-01-01&c=TESTKEY"
    ...
    def test_historical_eurostat_multiple_ids_with_dates(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/eurostat/historical/24804%2C24805?d1=2015-01-01&d2=2020-01-01&c=TESTKEY"
