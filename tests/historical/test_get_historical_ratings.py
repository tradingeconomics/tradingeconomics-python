...
class TestGetHistoricalRatings(unittest.TestCase):
    ...
    def test_historical_ratings_country_single(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/ratings/historical/united%20states?c=TESTKEY"
    ...
    def test_historical_ratings_country_multiple(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/ratings/historical/united%20states%2Cunited%20kingdom?c=TESTKEY"
    ...
    def test_historical_ratings_with_init_date(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/ratings/historical/united%20states/2011-01-01?c=TESTKEY"
    ...
    def test_historical_ratings_with_date_range(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/ratings/historical/united%20states/2011-01-01/2012-01-01?c=TESTKEY"
