...
class TestGetCmtTwoCountries(unittest.TestCase):
    ...
    def test_missing_second_country(self, mock_dataRequest):
        ...
        https://api.tradingeconomics.com/comtrade/country/country1?c=guest:guest
        """
    ...
    def test_two_countries(self, mock_dataRequest):
        ...
        https://api.tradingeconomics.com/comtrade/country/<c1>/<c2>?c=guest:guest
        """
        mock_dataRequest.return_value = {"ok": True}
    ...
    def test_two_countries_with_page(self, mock_dataRequest):
        """
        Page number must be appended before ?c=apikey.
        """
        mock_dataRequest.return_value = {"ok": True}
        ...
        expected_url = (
            "https://api.tradingeconomics.com/comtrade/country/portugal/spain/4?c=guest:guest"
        )
