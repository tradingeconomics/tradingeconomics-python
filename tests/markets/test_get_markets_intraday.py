...
class TestGetMarketsIntraday(unittest.TestCase):
    ...
    def test_get_markets_intraday_single(self, mock_request):
        ...
        expected_url = (
            "https://api.tradingeconomics.com/markets/intraday/indu%3Aind?c=TESTKEY"
        )
    ...
    def test_get_markets_intraday_multiple(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/markets/intraday/aapl%3Aus%2Cindu%3Aind?c=TESTKEY"
    ...
    def test_get_markets_intraday_with_init_date(self, mock_request, mock_validate):
        ...
        expected_url = "https://api.tradingeconomics.com/markets/intraday/indu%3Aind?c=TESTKEY&d1=2018-03-13"
    ...
    def test_get_markets_intraday_with_date_range(
        ...
        expected_url = "https://api.tradingeconomics.com/markets/intraday/aapl%3Aus%2Cindu%3Aind?c=TESTKEY&d1=2022-01-01&d2=2022-12-31"
