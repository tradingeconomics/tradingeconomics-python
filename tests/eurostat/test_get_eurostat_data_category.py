...
class TestGetEurostatDataCategory(unittest.TestCase):
    ...
    def test_category_parameter_single(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/eurostat?category=People%20at%20risk%20of%20income%20poverty%20after%20social%20transfers&c=TESTKEY"
    ...
    def test_category_parameter_multiple(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/eurostat?category=Category1%2CCategory2&c=TESTKEY"
