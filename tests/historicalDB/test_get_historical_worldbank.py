...
class TestGetHistoricalWorldBank(unittest.TestCase):
    ...
    def test_historical_worldbank_symbol(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/worldBank/historical?s=are.fr.inr.rinr&c=TESTKEY"
    ...
    def test_historical_worldbank_with_dates(
        ...
        expected_url = "https://api.tradingeconomics.com/worldBank/historical?s=are.fr.inr.rinr&d1=2010-01-01&d2=2020-01-01&c=TESTKEY"
