...
class TestgetCalendarId(unittest.TestCase):
    ...
    def test_getCalendarIdWithIds(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/calendarid/174108,160025,160030?c='
    ...
    def test_getCalendarIdNoId(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarIdWithId(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/calendarid/174108?c='
        data = requests.get(url).json()
...
class TestgetCalendarData(unittest.TestCase):
    ...
    def test_getCalendarDataImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountryAllWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/all/2011-01-01/2016-01-01?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataWithDatesAndImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/all/2016-01-01/2016-01-01?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountry(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountryWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states/2011-01-01/2016-01-01?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountryWithDatesAndImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states/2011-01-01/2016-01-01?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCategory(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/indicator/inflation rate?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCategoryWithImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/indicator/inflation rate?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCategoryWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/indicator/inflation rate/2016-03-01/2016-03-03?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCategoryWithDatesAndImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/indicator/inflation rate/2016-03-01/2016-03-03?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountries(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states,china?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountriesWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states,china?c=&importance=2'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountriesWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states,china/2016-03-01/2016-03-03?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountriesWithDatesAndImportance(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states,china/2016-03-01/2016-03-03?c=&importance=3'
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountryAndCategory(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states/indicator/initial jobless claims?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataCountryAndCategoryWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states/indicator/initial jobless claims/2011-01-01/2016-01-01?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataTicker(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/ticker/IJCUSA,SPAINFACORD,BAHRAININFNRATE?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataTickerWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/ticker/IJCUSA,SPAINFACORD,BAHRAININFNRATE/2021-01-01/2021-01-03?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarDataWithEvent(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united%20states/event/GDP Growth Rate QoQ Final/2016-12-01/2024-02-25?c='
        data = requests.get(url).json()
...
class TestgetCalendarEvents(unittest.TestCase):
    ...
    def test_getCalendarEventsNoArguments(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/events?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarEventsCountry(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/events/country/united%20states?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarEventsMultipleCountries(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/events/country/united%20states,china?c='
        data = requests.get(url).json()
...
class TestgetCalendarEventsByGroup(unittest.TestCase):
    ...
    def test_getCalendarEventsByGroupNoArguments(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/group/bonds?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarEventsByGroupWithDates(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/group/bonds/2023-01-01/2023-02-01?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarEventsByGroupWithDate(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/group/bonds/2023-02-01?c='
        data = requests.get(url).json()
    ...
    def test_getCalendarEventByGroupWithCountry(self):
        ...
        url = f'https://api.tradingeconomics.com/calendar/country/united states/group/bonds?c='
        data = requests.get(url).json()
