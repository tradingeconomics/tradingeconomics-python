...
class TestGetFinancialsHistoricalDates(unittest.TestCase):
    ...
    def test_financials_historical_with_init_date(self, mock_request, mock_validate):
        ...
        expected_url = "http://api.tradingeconomics.com/financials/historical/aapl%3Aus%3Aassets?c=TESTKEY&d1=2023-01-01"
    ...
    def test_financials_historical_with_date_range(
        ...
        expected_url = "http://api.tradingeconomics.com/financials/historical/aapl%3Aus%3Aassets?c=TESTKEY&d1=2023-01-01&d2=2023-12-31"
