...
class TestGetArticlesDates(unittest.TestCase):
    ...
    def test_get_articles_with_date_range(
        ...
        expected_url = "https://api.tradingeconomics.com/articles/country/United%20States/from/2015-10-10/2017-10-10?c=TESTKEY"
    ...
    def test_get_articles_multiple_countries_with_dates(
        ...
        expected_url = "https://api.tradingeconomics.com/articles/country/United%20States,Portugal/from/2015-10-10/2017-10-10?c=TESTKEY"
