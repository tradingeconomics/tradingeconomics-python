...
class TestGetArticlesBasic(unittest.TestCase):
    ...
    def test_get_articles_by_country(self, mock_request):
        ...
        expected_url = "/articles/country/United%20States"
    ...
    def test_get_articles_by_multiple_countries(self, mock_request):
        ...
        expected_url = "/articles/country/United%20States,Portugal"
    ...
    def test_get_articles_by_indicator(self, mock_request):
        ...
        expected_url = "/articles/indicator//inflation%20rate"
    ...
    def test_get_articles_by_country_and_indicator(self, mock_request):
        ...
        expected_url = (
            "/articles/country/United%20States,Portugal/Imports,Interest%20rate"
        )
    ...
    @patch(
        "tradingeconomics.news.fn.dataRequest",
        return_value={"raw": "json", "articles": "data"},
    )
    def test_get_articles_with_output_type_raw(self, mock_request):
        # Test with output_type='raw'
        result = getArticles(country="United States", output_type="raw")
        ...
        self.assertEqual(result, {"raw": "json", "articles": "data"})
