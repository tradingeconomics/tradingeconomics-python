...
class TestGetArticlesPagination(unittest.TestCase):
    ...
    def test_get_articles_with_start_and_limit(self, mock_request):
        ...
        expected_url = (
            "https://api.tradingeconomics.com/articles/?c=TESTKEY&lim=20&start=10"
        )
    ...
    def test_get_articles_country_with_start_and_limit(self, mock_request):
        ...
        expected_url = "https://api.tradingeconomics.com/articles/country/United%20States/inflation%20rate?c=TESTKEY&lim=100&start=20"
