...
class TestGetNewsDates(unittest.TestCase):
    ...
    def test_get_news_with_date_range(self, mock_request):
        ...
        expected_url = "/news?d1=2021-02-02&d2=2021-03-03"
    ...
    def test_get_news_indicator_with_dates(self, mock_request):
        ...
        expected_url = "/news/indicator/inflation%20rate?d1=2021-02-02&d2=2021-03-03"
    ...
    def test_get_news_country_indicator_with_dates(self, mock_request):
        ...
        expected_url = "/news/country/brazil,canada/Housing%20Starts,Stock%20Market?d1=2021-02-02&d2=2021-03-03"
